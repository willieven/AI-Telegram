...
USERS = {
    'user1': {
        ...
        'VEHICLE_ANIMAL_DISTANCE_THRESHOLD': 50,
...
# ENABLE_VEHICLE_ANIMAL_DETECTION: Set to True to detect vehicles with animals loaded.
...
# VEHICLE_ANIMAL_DISTANCE_THRESHOLD: The maximum distance (in pixels) between a vehicle and an animal to be considered "loaded".
